import './App.css';
import Portfolio from './assets/Photo.png';
			...
			<header
				...
				<div className='container m-auto px-4 py-6 max-w-4xl bg-black'>
					<div className='flex flex-col gap-4 sm:flex-row justify-between items-center'>
						<div>
							<h1 className='font-bold text-2xl'>Dastan Portfolio</h1>
						</div>
						<div>
					...
					<div className='container m-auto px-4 sm:py-12'>
						...
						<div className='flex flex-col sm:flex-row gap-10 mt-11'>
							<div className='border border-gray-500 rounded-md p-5 flex-1'>
								...
								<p className='text-gray-400 text-sm mt-2'>
									Responsive React/Redux layout for online furniture store.
									HTML5, CSS3 (SCSS)
								</p>
							...
							<div className='border border-gray-500 rounded-md p-5 flex-1'>
								...
								<p className='text-gray-400 text-sm mt-2'>
									Responsive React/SCSS layout for online store of designer
						...
						<div className='flex flex-col sm:flex-row  gap-10 mt-11'>
							<div className='border border-gray-500 rounded-md p-5 flex-1'>
								...
								<p className='text-gray-400 text-sm mt-2'>
									Responsive React/SCSS layout for landing page for front-end
							...
							<div className='border border-gray-500 rounded-md p-5 flex-1'>
								...
								<p className='text-gray-400 text-sm mt-2'>
									Responsive React/CSS layout for The Venus project. HTML5, CSS3
									(SCSS)
								</p>
								<div className='flex gap-2 mt-12'>
									<button className='flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700'>
						...
						<div className='mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white'>
							<div className='pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]'>
								...
								<p>
									...
									qualified as a Cross fit trainer.
								</p>
							</div>
			...
			<footer>
				<div className='container m-auto flex justify-between px-4 py-6'>
					...
					<div>
						<ul className='flex gap-4'>
							<li>
								<a href='https://web.telegram.org/a/#-1001518139662'>
									<img
										src={Facebook}
										className='w-5 bg-blue-500 rounded-2xl '
									/>
								</a>
							</li>
							<li>
								<a href='https://www.linkedin.com/jobs/search/?currentJobId=3737276677&geoId=103490790&keywords=%D0%92%D0%B5%D0%B1-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B0&location=%D0%9A%D0%B8%D1%80%D0%B3%D0%B8%D0%B7%D0%B8%D1%8F&origin=JOB_SEARCH_PAGE_KEYWORD_AUTOCOMPLETE&refresh=true'>
									<img src={LinkedIn} className='w-5 bg-blue-500 rounded-sm' />
								</a>
							</li>
							<li>
								<a href='https://www.instagram.com/du1atbekov_'>
